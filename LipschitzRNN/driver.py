...
if args.name == 'mnist':
    ...
    model = RnnModels(input_dim=int(784/args.T), output_classes=10, n_units=args.n_units, 
    ...
    model = RnnModels(input_dim=int(1024/args.T*3), output_classes=10, n_units=args.n_units, 
                 eps=args.eps, beta=args.beta, gamma=args.gamma, gated=args.gated,
                 model=args.model, init_std=args.init_std, alpha=args.alpha, solver=args.solver).to(device) 
    ...
    model = RnnModels(input_dim=int(96), output_classes=10, n_units=args.n_units, 
                 eps=args.eps, beta=args.beta, gamma=args.gamma, gated=args.gated,
                 model=args.model, init_std=args.init_std, alpha=args.alpha, solver=args.solver).to(device)     
